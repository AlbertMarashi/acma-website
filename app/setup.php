...
add_action('after_setup_theme', function () {
     ...
     */
    register_nav_menus([
        'primary-nav' => __('Primary Navigation', 'sage'),
    ...
    add_filter( 'get_search_form', function ($form) {
        $form = '<div>
            <input type="text" value="' . get_search_query() . '" name="src" id="src" />
            <a class="button secondary search" onClick="window.location.href = \''.home_url('/?s=').'\' + document.getElementById(\'src\').value">
